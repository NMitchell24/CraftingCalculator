...
namespace CraftingCalculator.Model.Recipes
{
    public class RecipeFilterLabels
    {
        ...
        public const string AccessCard                      = "Access Card";
        public const string AdvancedAgriculturalProduct     = "Advanced Agricultural Product";
        public const string AdvancedCraftedProduct          = "Advanced Crafted Product";
        public const string AlloyMetal                      = "Alloy Metal";
        public const string AtlasSeed                       = "Atlas Seed";
        public const string BaseAquaticConstruction         = "Base Aquatic Construction";
