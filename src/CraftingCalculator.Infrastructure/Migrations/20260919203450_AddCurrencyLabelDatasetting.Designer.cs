...
namespace CraftingCalculator.Infrastructure.Migrations
{
    ...
    [Migration("20260919203450_AddCurrencyLabelDatasetting")]
    partial class AddCurrencyLabelDatasetting
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CraftingCalculator.Domain.Entities.Dataset", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
                    ...
                    b.Property<bool>("UseCosts")
                        .HasColumnType("INTEGER");

                    b.Property<bool>("UseCraftTime")
                        .HasColumnType("INTEGER");

                    b.Property<bool>("UseValues")
                        .HasColumnType("INTEGER");

                    b.Property<bool>("UseYield")
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("CraftingCalculator.Domain.Entities.Blueprint", b =>
                {
                    ...
                    b.HasOne("CraftingCalculator.Domain.Entities.Dataset", "Dataset")
                        .WithMany("Blueprints")
