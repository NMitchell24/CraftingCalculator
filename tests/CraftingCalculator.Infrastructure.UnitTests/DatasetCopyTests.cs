...
public class DatasetCopyTests
{
    ...
    public async Task CopyAsync_CopiesTheSettings(bool useYield, bool useCosts, bool useValues)
    {
        ...
        (await _datasetDAO.GetByIdAsync(copy.Id))!.Settings.Should().Be(settings);
    }
